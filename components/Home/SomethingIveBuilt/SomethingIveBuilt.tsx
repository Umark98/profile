  ...
  return (
    ...
    >
      ...
      <div data-aos="fade-up" className=" flex flex-row  items-center md:px-0">
       ...
       {/* Shopify Project */}
      <div className="relative grid grid-cols-12 gap-4 w-full h-auto">
        <div className="col-span-5 flex flex-col items-start space-y-4">
          <span className="text-AAsecondary text-sm">Shopify Project</span>
          <h3 className="text-gray-200 font-bold text-xl">
            Custom Shopify Store
          </h3>
          <p className="text-gray-300">
            A fully customized Shopify store with tailored product pages,
            unique checkout experience, and integration with third-party apps.
          </p>
        ...
        <div className="col-span-7">
          <a href="https://championshipbeltmaker.com/" target="_blank" rel="noreferrer">
            <Img
              src="/shopify.png"
              alt="Shopify Project"
              className="rounded w-full h-auto transition-opacity hover:opacity-80"
            />
          </a>
        </div>
      </div>
      ...
      <div className="relative grid grid-cols-12 gap-4 w-full h-auto">
        <div className="col-span-7 order-last md:order-first">
          <a href="https://cybillnerd.com/" target="_blank" rel="noreferrer">
            <Img
              src="/wordpress.png"
        ...
        <div className="col-span-5 flex flex-col items-start md:items-end space-y-4">
          <span className="text-AAsecondary text-sm">WordPress Project</span>
          <h3 className="text-gray-200 font-bold text-xl">
            Dynamic WordPress Site
          </h3>
          <p className="text-gray-300">
            Developed a WordPress site with custom plugins, SEO optimization,
            and responsive design for optimal performance.
          </p>
          <ul className="flex space-x-4 text-gray-400 text-sm">
            <li>WordPress</li>
            <li>SEO</li>
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right ">
                  ...
                  components for their <span className="text-AAsecondary">web3 application</span> using Next.js and web3 libraries. Our focus was on integrating new features and improving the user interface.
                  libraries. Our focus was on integrating new features and improving the user interface.
                </p>
              </div>
              <ul
